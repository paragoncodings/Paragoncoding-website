        ...
        <div className="container mx-auto px-4 ">
          <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-4 gap-8 gap-y-16 ">
            {displayedMembers.map((member, index) => (
              <div
                key={index}
                className="flex flex-col bg-gray-100 rounded-lg shadow-md overflow-hidden border border-green"
              >
                <Link
                  to={`/teamdisplay/${member.id}`}
                  ...
                  <div className="relative z-10 ">
                    <h3 className="text-xl font-semibold mb-2 group-hover:text-white">
                      <Link
                        ...
                        className="text-green group-hover:text-dark"
                      >
                        {member.name}
                      </Link>
                    </h3>
                    <p className="text-blue  group-hover:text-dark">
                      {member.position}
                    </p>
                  </div>
                  <span className="absolute inset-0 bg-blue transform scale-y-0 origin-top transition-transform duration-500 ease-in-out group-hover:scale-y-100"></span>
>>>>>>> c24e71e65cad0584e502cd6d7270cb382a77c41d
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="py-4 flex items-center justify-center">
          <Link to="/team">
            <button className=" mt-20 w-32 sm:w-40 py-2 text-blue border border-green  hover:text-dark bg-white rounded-2xl relative overflow-hidden group">
