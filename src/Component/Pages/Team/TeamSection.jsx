                ...
                <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-4 gap-8 gap-y-16 ">
                    { displayedMembers.map((member, index) => (
                        <div key={index} className="flex flex-col bg-gray-100 rounded-lg shadow-md overflow-hidden border border-green">
                            ...
                            <div className="cursor-pointer p-4 w-auto max-[425px]:ml-20 ml-6  border border-green bg-dark absolute mt-60 shadow-xl rounded-md  text-center group transition-all  ">
                                ...
                                <div className="relative z-10 ">
                                    ...
                                    <p className="text-blue  group-hover:text-dark w-auto">{member.position}</p>
                                </div>
